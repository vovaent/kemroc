<?php /* Template Name: Page Datenschutz */
    ...
    <div class="container">
        ...
        <section class="grayplate-text">
            <div class="grayplate-text__wrap">
                    ...
                    KEMROC Spezialmaschinen GmbH<br>
                    Jeremiasstraße 4<br>
                    36433 Leimbach
                    </p>
                    <p>Telefon: +49 3695 850 2550<br>
                    E-Mail: info@kemroc.de</p>
        ...
        <section class="grayplate-text">
            <div class="grayplate-text__wrap">
                    ...
                    <h5>Cookie-Einwilligung mit Cookiebot</h5>
                    <p>Unsere Website nutzt die Cookie-Consent-Technologie von Cookiebot, um Ihre Einwilligung zur Speicherung bestimmter Cookies auf Ihrem Endgerät einzuholen und diese datenschutzkonform zu dokumentieren. Anbieter dieser Technologie ist Cybot A/S, Havnegade 39, 1058 Kopenhagen, Dänemark (im Folgenden „Cookiebot“).</p>
                    ...
                    <p>Der Einsatz von Cookiebot erfolgt, um die gesetzlich vorgeschriebenen Einwilligungen für den Einsatz von Cookies einzuholen. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 S. 1 lit. c DSGVO.</p>
                    ...
                    <p>Cookies sind kleine Textdateien, die von Webseiten verwendet werden, um die Benutzererfahrung effizienter zu gestalten.Laut Gesetz können wir Cookies auf Ihrem Gerät speichern, wenn diese für den Betrieb dieser Seite unbedingt notwendig sind. Für alle anderen Cookie-Typen benötigen wir Ihre Erlaubnis.Diese Seite verwendet unterschiedliche Cookie-Typen. Einige Cookies werden von Drittparteien platziert, die auf unseren Seiten erscheinen.Sie können Ihre Einwilligung jederzeit von der Cookie-Erklärung auf unserer Website ändern oder widerrufen.Erfahren Sie in unserer Datenschutzrichtlinie mehr darüber, wer wir sind, wie Sie uns kontaktieren können und wie wir personenbezogene Daten verarbeiten.Bitte geben Sie Ihre Einwilligungs-ID und das Datum an, wenn Sie uns bezüglich Ihrer Einwilligung kontaktieren.</p>
                    <p>Ihre Einwilligung trifft auf die folgenden Domains zu: www.kemroc.de<br>
                    Die Cookie-Erklärung wurde das letzte Mal am 09.05.2023 von Cookiebot aktualisiert:<br>
                    Notwendig (2)<br>
                    ...
                    <tr>
                        ...
                        <td>Wird verwendet, um festzustellen, ob der Besucher die Marketingkategorie im Cookie-Banner akzeptiert hat. Dieser Cookie ist notwendig für die Einhaltung der DSGVO der Webseite.</td>
                        <td>2 Jahre</td>
                        <td>HTTP Cookie</td>
                    </tr>
                    <tr>
                        <td>CookieConsent</td>
                        <td><a href="#">Cookiebot</a></td>
