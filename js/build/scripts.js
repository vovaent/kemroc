...
const modelInfo = $ => {
  ...
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper.model-tabs__slider', {
...
const productModelList = $ => {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper.model-list__slider', {
