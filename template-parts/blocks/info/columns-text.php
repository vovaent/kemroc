...
if ( ! $is_preview ) :
	...
	<section id="<?php echo esc_attr( $kemroc_columns_text_id ); ?>"
		class="<?php echo esc_attr( $kemroc_columns_text_class_name ); ?>">
		<div class="container">
			<?php if ( $rows ) { ?>
					...
					<section class="columns-text">
						...
						<div class="columns-text__wrap">
							...
							<?php if ( $row['text_der_zweiten_spalte'] ) : ?>
									<p><?php echo $row['text_der_zweiten_spalte']; ?>
							<?php endif; ?>
						</div>
					</section>
				<?php } ?>
			...
			<section class="columns-text postscript">
				<?php if ( $postscript_title ) : ?>
					<h6>
						<?php echo $postscript_title; ?>
					</h6>
				<?php endif; ?>
				<?php if ( $postscript_text ) : ?>
					<div class="columns-text__wrap">
							<p><?php echo $postscript_text; ?>
					</div>
				<?php endif; ?>
			</section>
		</div>
