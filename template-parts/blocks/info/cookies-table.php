	  ...
	  <div class="grayplate-text">
		...
		if ( $rows ) {
		  ...
		  <table style="width:100%" cellspacing="0" cellpadding="0">
			<tr>
			  <th><?php esc_html_e( 'NAME', 'kemroc' ); ?></th>
			  <th><?php esc_html_e( 'ANBIETER', 'kemroc' ); ?></th>
			  <th><?php esc_html_e( 'ZWECK', 'kemroc' ); ?></th>
			  <th><?php esc_html_e( 'ABLAUF', 'kemroc' ); ?></th>
			  <th><?php esc_html_e( 'TYP', 'kemroc' ); ?></th>
			</tr>
