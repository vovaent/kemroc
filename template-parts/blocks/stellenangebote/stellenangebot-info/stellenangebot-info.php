	...
	<div class="container post_wrap">
		<div class="post_wrap_column-1">
			<section class="posts__title">
				<div class="item-subtitle"><?php echo esc_html( $kemroc_si_above_title ); ?></div>
			...
			<section class="posts__beschreibung">
				<?php if ( $post_beschreibung ) : ?>
					<div class="item-beschreibung"><?php echo $post_beschreibung; ?></div>
				<?php endif; ?>
			</section>
				...
				<form id="cf-form" class="contacts-form__form cf-form">
					<div class="cf-form__top">
						<div class="cf-form__left">
							...
							<label class="cf-form__label cf-form__label--resume">
								<input type="file" name="resume" size="40" class="cf-form__field cf-form__field--file" id="resumeFile" accept=".pdf,.txt,.doc,.docx,.jpg,.png">
								<p>
								<?php 
								echo wp_kses(
