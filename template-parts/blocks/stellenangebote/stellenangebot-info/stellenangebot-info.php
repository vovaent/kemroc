...
if ( ! $is_preview ) :
	...
	$kemroc_si_form_messages = array(
		...
		'empty_checkbox'      => ! empty( $kemroc_si_form_data['error_text_empty_checkbox'] ) ? $kemroc_si_form_data['error_text_empty_checkbox'] : esc_html__( 'Um das Formular abzuschicken, müssen Sie die Vereinbarung akzeptieren und das Kästchen ankreuzen.', 'kemroc' ),
